...
<meta content="webkit" name="renderer" /><meta name="applicable-device" content="pc"><meta http-equiv="X-UA-Compatible" content="IE=8" />
...
<div id="header-bg" class="header-bg"></div>
    ...
    <div class="inner-wrapper">
            <div id="header-search" class="header-search">
                <form id="header-search-form" class="header-search-form" method="post" action="cinema/keySearch.do">
